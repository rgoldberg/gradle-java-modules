...
RuntimeJavaOptionsInternal() {
        ...
        AutoGeneratableCascading by DefaultAutoGeneratableCascading(this) {
            ...
            get() {
                if (autoGenerate.isEnabled) {
                    ...
                    if (javaExec.project.plugins.getPlugin(JigsawPlugin::class.java).getModuleName(main) != null) {
    ...
    override val modulePath: AutoGeneratableSeparableValueSetOptionInternal<String> by lazy {
        ...
        AutoGeneratableCascading by DefaultAutoGeneratableCascading(this) {
            ...
            get() =
                super.value.appendAutoGeneratedIterator(
                    autoGenerate.isEnabled
                    && javaExec.project.plugins.getPlugin(JigsawPlugin::class.java).getModuleName(javaExec.main) != null
                ) {
